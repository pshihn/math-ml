...
function polyfillChildren(target: Element, current: Element) {
...
function getCustomElementName(node: Element): string {
...
function hasMathMLSupport() {
  ...
  const box = div.firstChild && div.firstChild.firstChild && (div.firstChild.firstChild as Element).getBoundingClientRect();
