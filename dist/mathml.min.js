...
`;let he=class extends oe{render(){return q`
    ...
    `}updated(){this.onSlotChange()}onSlotChange(){if(!this.shadowRoot)return;const e=this.shadowRoot.querySelector("span");if(!e)return;let t="",n=this.form;if(!n){const e=this.parentElement;if(e){const t=e.children;1<t.length&&(t[0]===this?n="prefix":t[t.length-1]===this&&(n="postfix"))}const r=(this.textContent||"").trim();","===r||";"===r?t="separator":"."===r||"\u22C5"===r?t="product":r.match(/^[\[{(]*$/)?t="begin-brace":r.match(/^[\]})]*$/)&&(t="end-brace")}n=n||"infix";const r=t||n;this.formStyle!==r&&(this.formStyle&&this.classList.remove(this.formStyle),this.formStyle=`mo-${r}`,this.classList.add(this.formStyle));let o=this.stretchy;o===void 0&&("true"===getComputedStyle(this).getPropertyValue("--math-style-stretchy").trim()?o=!0:o="prefix"===n||"postfix"===n||"begin-brace"==t||"end-brace"==t),e.style.width=null,o?(e.style.lineHeight="1",setTimeout(()=>{if(e.style.transform)return;e.classList.remove("invisible");const t=e.getBoundingClientRect(),n=this.getBoundingClientRect(),r=t.height?n.height/t.height:1,o=t.width?n.width/t.width:1;1>=r&&(e.style.lineHeight=null),1!==o&&(e.style.width="100%"),e.style.transform=`scale(${o}, ${r})`},50)):(e.style.transform=null,e.style.lineHeight=null,e.classList.remove("invisible"))}};ye([ne({type:String}),me("design:type",String)],fe.prototype,"form",void 0),ye([ne({type:Boolean}),me("design:type",Boolean)],fe.prototype,"stretchy",void 0),fe=ye([r("m-o")],fe);let be=class extends oe{render(){return q`
    <style>
      :host {
        display: inline-block;
        font-style: italic;
