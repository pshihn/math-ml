...
`;let he=class extends oe{render(){return L`
    ...
    `}refreshSlot(){if(!this.shadowRoot)return;const e=this.shadowRoot.querySelector("slot");if(!e)return;const t=e.assignedNodes().filter(e=>e.nodeType===Node.ELEMENT_NODE);1<t.length&&setTimeout(()=>{const e=t[0].getBoundingClientRect(),n=t[1],r=n.getBoundingClientRect();n.style.opacity="1";const o=[0,0],d=r.bottom-(e.bottom-e.height/2);0<d&&(n.style.top=`${-d}px`,o[0]=d),o[1]=r.width+3,this.style.margin=`${o[0]}px ${o[1]}px 0 0`},50)}};ke=function(e,t,n,o){var a,s=arguments.length,l=3>s?t:null===o?o=Object.getOwnPropertyDescriptor(t,n):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)l=Reflect.decorate(e,t,n,o);else for(var p=e.length-1;0<=p;p--)(a=e[p])&&(l=(3>s?a(l):3<s?a(t,n,l):a(t,n))||l);return 3<s&&l&&Object.defineProperty(t,n,l),l}([r("m-sup")],ke);let Me=class extends oe{render(){return L`
    <style>
      ${ce}
      :host {
        display: inline-block;
