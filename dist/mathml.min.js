var mathml=function(e){"use strict";var d=Math.max;function t(e){let t=L.get(e.type);void 0===t&&(t=new Map,L.set(e.type,t));let n=t.get(e.strings);return void 0===n&&(n=new g(e,e.getTemplateElement()),t.set(e.strings,n)),n}function n(e,t){const{element:{content:r},parts:n}=e,o=document.createTreeWalker(r,q,null,!1);let d=B(n),a=n[d],i=-1,l=0;const s=[];for(let r=null;o.nextNode();){i++;const e=o.currentNode;for(e.previousSibling===r&&(r=null),t.has(e)&&(s.push(e),null===r&&(r=e)),null!==r&&l++;void 0!==a&&a.index===i;)a.index=null===r?a.index-l:-1,d=B(n,d),a=n[d]}s.forEach(e=>e.parentNode.removeChild(e))}function r(e,t,n=null){const{element:{content:o},parts:r}=e;if(null===n||void 0===n)return void o.appendChild(t);const d=document.createTreeWalker(o,q,null,!1);let a=B(r),i=0,l=-1;for(;d.nextNode();){l++;const e=d.currentNode;for(e===n&&(i=V(t),n.parentNode.insertBefore(t,n));-1!==a&&r[a].index===l;){if(0<i){for(;-1!==a;)r[a].index+=i,a=B(r,a);return}a=B(r,a)}}}function o(e){return ne(e)}const a=new WeakMap,i=e=>"function"==typeof e&&a.has(e),l=void 0!==window.customElements&&void 0!==window.customElements.polyfillWrapFlushCallback,s=(e,t,n=null)=>{for(let r=t;r!==n;){const t=r.nextSibling;e.removeChild(r),r=t}},p={},h=`{{lit-${(Math.random()+"").slice(2)}}}`,c=`<!--${h}-->`,u=new RegExp(`${h}|${c}`),m=(()=>{const e=document.createElement("div");return e.setAttribute("style","{{bad value}}"),"{{bad value}}"!==e.getAttribute("style")})();class g{constructor(e,t){this.parts=[],this.element=t;let n=-1,r=0;const o=[],d=t=>{const a=t.content,i=document.createTreeWalker(a,133,null,!1);let l,s;for(;i.nextNode();){n++,l=s;const t=s=i.currentNode;if(1===t.nodeType){if(t.hasAttributes()){const o=t.attributes;let d=0;for(let e=0;e<o.length;e++)0<=o[e].value.indexOf(h)&&d++;for(;0<d--;){const o=e.strings[r],d=b.exec(o)[2],a=m&&"style"===d?"style$":/^[a-zA-Z-]*$/.test(d)?d:d.toLowerCase(),i=t.getAttribute(a),l=i.split(u);this.parts.push({type:"attribute",index:n,name:d,strings:l}),t.removeAttribute(a),r+=l.length-1}}"TEMPLATE"===t.tagName&&d(t)}else if(3===t.nodeType){const e=t.nodeValue;if(0>e.indexOf(h))continue;const d=t.parentNode,a=e.split(u),l=a.length-1;r+=l;for(let e=0;e<l;e++)d.insertBefore(""===a[e]?f():document.createTextNode(a[e]),t),this.parts.push({type:"node",index:n++});d.insertBefore(""===a[l]?f():document.createTextNode(a[l]),t),o.push(t)}else if(8===t.nodeType)if(t.nodeValue===h){const e=t.parentNode,d=t.previousSibling;null===d||d!==l||d.nodeType!==Node.TEXT_NODE?e.insertBefore(f(),t):n--,this.parts.push({type:"node",index:n++}),o.push(t),null===t.nextSibling?e.insertBefore(f(),t):n--,s=l,r++}else for(let e=-1;-1!==(e=t.nodeValue.indexOf(h,e+1));)this.parts.push({type:"node",index:-1})}};d(t);for(const r of o)r.parentNode.removeChild(r)}}const y=e=>-1!==e.index,f=()=>document.createComment(""),b=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F \x09\x0a\x0c\x0d"'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;class E{constructor(e,t,n){this._parts=[],this.template=e,this.processor=t,this.options=n}update(e){let t=0;for(const n of this._parts)void 0!==n&&n.setValue(e[t]),t++;for(const t of this._parts)void 0!==t&&t.commit()}_clone(){const e=l?this.template.element.content.cloneNode(!0):document.importNode(this.template.element.content,!0),t=this.template.parts;let n=0,r=0;const o=e=>{const d=document.createTreeWalker(e,133,null,!1);for(let a=d.nextNode();n<t.length&&null!==a;){const e=t[n];if(!y(e))this._parts.push(void 0),n++;else if(r===e.index){if("node"===e.type){const e=this.processor.handleTextExpression(this.options);e.insertAfterNode(a),this._parts.push(e)}else this._parts.push(...this.processor.handleAttributeExpressions(a,e.name,e.strings,this.options));n++}else r++,"TEMPLATE"===a.nodeName&&o(a.content),a=d.nextNode()}};return o(e),l&&(document.adoptNode(e),customElements.upgrade(e)),e}}class P{constructor(e,t,n,r){this.strings=e,this.values=t,this.type=n,this.processor=r}getHTML(){const e=this.strings.length-1;let t="",n=!0;for(let r=0;r<e;r++){const e=this.strings[r];t+=e;const o=e.lastIndexOf(">");n=(-1<o||n)&&-1===e.indexOf("<",o+1),!n&&m&&(t=t.replace(b,(e,t,n,r)=>"style"===n?`${t}style$${r}`:e)),t+=n?c:h}return t+=this.strings[e],t}getTemplateElement(){const e=document.createElement("template");return e.innerHTML=this.getHTML(),e}}const w=e=>null===e||"object"!=typeof e&&"function"!=typeof e;class S{constructor(e,t,n){this.dirty=!0,this.element=e,this.name=t,this.strings=n,this.parts=[];for(let r=0;r<n.length-1;r++)this.parts[r]=this._createPart()}_createPart(){return new M(this)}_getValue(){const e=this.strings,t=e.length-1;let n="";for(let r=0;r<t;r++){n+=e[r];const t=this.parts[r];if(void 0!==t){const e=t.value;if(null!=e&&(Array.isArray(e)||"string"!=typeof e&&e[Symbol.iterator]))for(const r of e)n+="string"==typeof r?r:r+"";else n+="string"==typeof e?e:e+""}}return n+=e[t],n}commit(){this.dirty&&(this.dirty=!1,this.element.setAttribute(this.name,this._getValue()))}}class M{constructor(e){this.value=void 0,this.committer=e}setValue(e){e===p||w(e)&&e===this.value||(this.value=e,!i(e)&&(this.committer.dirty=!0))}commit(){for(;i(this.value);){const e=this.value;this.value=p,e(this)}this.value===p||this.committer.commit()}}class v{constructor(e){this.value=void 0,this._pendingValue=void 0,this.options=e}appendInto(e){this.startNode=e.appendChild(f()),this.endNode=e.appendChild(f())}insertAfterNode(e){this.startNode=e,this.endNode=e.nextSibling}appendIntoPart(e){e._insert(this.startNode=f()),e._insert(this.endNode=f())}insertAfterPart(e){e._insert(this.startNode=f()),this.endNode=e.endNode,e.endNode=this.startNode}setValue(e){this._pendingValue=e}commit(){for(;i(this._pendingValue);){const e=this._pendingValue;this._pendingValue=p,e(this)}const e=this._pendingValue;e===p||(w(e)?e!==this.value&&this._commitText(e):e instanceof P?this._commitTemplateResult(e):e instanceof Node?this._commitNode(e):Array.isArray(e)||e[Symbol.iterator]?this._commitIterable(e):void 0===e.then?this._commitText(e):this._commitPromise(e))}_insert(e){this.endNode.parentNode.insertBefore(e,this.endNode)}_commitNode(e){this.value===e||(this.clear(),this._insert(e),this.value=e)}_commitText(e){const t=this.startNode.nextSibling;e=null==e?"":e,t===this.endNode.previousSibling&&t.nodeType===Node.TEXT_NODE?t.textContent=e:this._commitNode(document.createTextNode("string"==typeof e?e:e+"")),this.value=e}_commitTemplateResult(e){const t=this.options.templateFactory(e);if(this.value&&this.value.template===t)this.value.update(e.values);else{const n=new E(t,e.processor,this.options),r=n._clone();n.update(e.values),this._commitNode(r),this.value=n}}_commitIterable(e){Array.isArray(this.value)||(this.value=[],this.clear());const t=this.value;let n,r=0;for(const o of e)n=t[r],void 0===n&&(n=new v(this.options),t.push(n),0==r?n.appendIntoPart(this):n.insertAfterPart(t[r-1])),n.setValue(o),n.commit(),r++;r<t.length&&(t.length=r,this.clear(n&&n.endNode))}_commitPromise(e){this.value=e,e.then(t=>{this.value===e&&(this.setValue(t),this.commit())})}clear(e=this.startNode){s(this.startNode.parentNode,e.nextSibling,this.endNode)}}class _{constructor(e,t,n){if(this.value=void 0,this._pendingValue=void 0,2!==n.length||""!==n[0]||""!==n[1])throw new Error("Boolean attributes can only contain a single expression");this.element=e,this.name=t,this.strings=n}setValue(e){this._pendingValue=e}commit(){for(;i(this._pendingValue);){const e=this._pendingValue;this._pendingValue=p,e(this)}if(this._pendingValue!==p){const e=!!this._pendingValue;this.value!==e&&(e?this.element.setAttribute(this.name,""):this.element.removeAttribute(this.name)),this.value=e,this._pendingValue=p}}}class N extends S{constructor(e,t,n){super(e,t,n),this.single=2===n.length&&""===n[0]&&""===n[1]}_createPart(){return new x(this)}_getValue(){return this.single?this.parts[0].value:super._getValue()}commit(){this.dirty&&(this.dirty=!1,this.element[this.name]=this._getValue())}}class x extends M{}let C=!1;try{const e={get capture(){return C=!0,!1}};window.addEventListener("test",e,e),window.removeEventListener("test",e,e)}catch(e){}class T{constructor(e,t,n){this.value=void 0,this._pendingValue=void 0,this.element=e,this.eventName=t,this.eventContext=n}setValue(e){this._pendingValue=e}commit(){for(;i(this._pendingValue);){const e=this._pendingValue;this._pendingValue=p,e(this)}if(this._pendingValue===p)return;const e=this._pendingValue,t=this.value,n=null==e||null!=t&&(e.capture!==t.capture||e.once!==t.once||e.passive!==t.passive);n&&this.element.removeEventListener(this.eventName,this,this._options),this._options=R(e),null!=e&&(null==t||n)&&this.element.addEventListener(this.eventName,this,this._options),this.value=e,this._pendingValue=p}handleEvent(e){const t="function"==typeof this.value?this.value:"function"==typeof this.value.handleEvent?this.value.handleEvent:()=>null;t.call(this.eventContext||this.element,e)}}const R=e=>e&&(C?{capture:e.capture,passive:e.passive,once:e.once}:e.capture);const O=new class{handleAttributeExpressions(e,t,n,r){const o=t[0];if("."===o){const r=new N(e,t.slice(1),n);return r.parts}if("@"===o)return[new T(e,t.slice(1),r.eventContext)];if("?"===o)return[new _(e,t.slice(1),n)];const d=new S(e,t,n);return d.parts}handleTextExpression(e){return new v(e)}},L=new Map,D=new WeakMap,j=(e,n,r)=>{let o=D.get(n);void 0===o&&(s(n,n.firstChild),D.set(n,o=new v(Object.assign({templateFactory:t},r))),o.appendInto(n)),o.setValue(e),o.commit()},A=(e,...t)=>new P(e,t,"html",O),q=NodeFilter.SHOW_ELEMENT|NodeFilter.SHOW_COMMENT|NodeFilter.SHOW_TEXT,V=e=>{let t=e.nodeType===Node.DOCUMENT_FRAGMENT_NODE?0:1;for(const n=document.createTreeWalker(e,q,null,!1);n.nextNode();)t++;return t},B=(e,t=-1)=>{for(let n=t+1;n<e.length;n++){const t=e[n];if(y(t))return n}return-1},k=(e,t)=>`${e}--${t}`;let U=!0;"undefined"==typeof window.ShadyCSS?U=!1:"undefined"==typeof window.ShadyCSS.prepareTemplateDom&&(console.warn("Incompatible ShadyCSS version detected.Please update to at least @webcomponents/webcomponentsjs@2.0.2 and@webcomponents/shadycss@1.3.1."),U=!1);const F=e=>t=>{const n=k(t.type,e);let r=L.get(n);void 0===r&&(r=new Map,L.set(n,r));let o=r.get(t.strings);if(void 0===o){const n=t.getTemplateElement();U&&window.ShadyCSS.prepareTemplateDom(n,e),o=new g(t,n),r.set(t.strings,o)}return o},I=["html","svg"],z=e=>{I.forEach(t=>{const r=L.get(k(t,e));void 0!==r&&r.forEach(e=>{const{element:{content:t}}=e,r=new Set;Array.from(t.querySelectorAll("style")).forEach(e=>{r.add(e)}),n(e,r)})})},W=new Set,G=(e,t,o)=>{W.add(o);const d=e.querySelectorAll("style");if(0!==d.length){const a=document.createElement("style");for(let e=0;e<d.length;e++){const t=d[e];t.parentNode.removeChild(t),a.textContent+=t.textContent}if(z(o),r(t,a,t.element.content.firstChild),window.ShadyCSS.prepareTemplateStyles(t.element,o),window.ShadyCSS.nativeShadow){const n=t.element.content.querySelector("style");e.insertBefore(n.cloneNode(!0),e.firstChild)}else{t.element.content.insertBefore(a,t.element.content.firstChild);const e=new Set;e.add(a),n(t,e)}}},H=(e,t,n)=>{const r=n.scopeName,o=D.has(t);if(j(e,t,Object.assign({templateFactory:F(r)},n)),t instanceof ShadowRoot&&U&&e instanceof P){if(!W.has(r)){const e=D.get(t),n=e.value;G(t,n.template,r)}o||window.ShadyCSS.styleElement(t.host)}},X=e=>null!==e,$=e=>e?"":null,J=(e,t)=>t!==e&&(t===t||e===e),Y={attribute:!0,type:String,reflect:!1,hasChanged:J},Z=new Promise(e=>e(!0)),Q=1,K=4,ee=8;class te extends HTMLElement{constructor(){super(),this._updateState=0,this._instanceProperties=void 0,this._updatePromise=Z,this._changedProperties=new Map,this._reflectingProperties=void 0,this.initialize()}static get observedAttributes(){this._finalize();const e=[];for(const[t,n]of this._classProperties){const r=this._attributeNameForProperty(t,n);void 0!==r&&(this._attributeToPropertyMap.set(r,t),e.push(r))}return e}static createProperty(e,t=Y){if(!this.hasOwnProperty("_classProperties")){this._classProperties=new Map;const e=Object.getPrototypeOf(this)._classProperties;void 0!==e&&e.forEach((e,t)=>this._classProperties.set(t,e))}if(this._classProperties.set(e,t),this.prototype.hasOwnProperty(e))return;const n="symbol"==typeof e?Symbol():`__${e}`;Object.defineProperty(this.prototype,e,{get(){return this[n]},set(r){const o=this[e];this[n]=r,this._requestPropertyUpdate(e,o,t)},configurable:!0,enumerable:!0})}static _finalize(){if(this.hasOwnProperty("_finalized")&&this._finalized)return;const e=Object.getPrototypeOf(this);"function"==typeof e._finalize&&e._finalize(),this._finalized=!0,this._attributeToPropertyMap=new Map;const t=this.properties,n=[...Object.getOwnPropertyNames(t),...("function"==typeof Object.getOwnPropertySymbols?Object.getOwnPropertySymbols(t):[])];for(const e of n)this.createProperty(e,t[e])}static _attributeNameForProperty(e,t){const n=void 0!==t&&t.attribute;return!1===n?void 0:"string"==typeof n?n:"string"==typeof e?e.toLowerCase():void 0}static _valueHasChanged(e,t,n=J){return n(e,t)}static _propertyValueFromAttribute(e,t){const n=t&&t.type;if(void 0===n)return e;const r=n===Boolean?X:"function"==typeof n?n:n.fromAttribute;return r?r(e):e}static _propertyValueToAttribute(e,t){if(void 0!==t&&void 0!==t.reflect){const n=t.type===Boolean?$:t.type&&t.type.toAttribute||String;return n(e)}}initialize(){this.renderRoot=this.createRenderRoot(),this._saveInstanceProperties()}_saveInstanceProperties(){for(const[e]of this.constructor._classProperties)if(this.hasOwnProperty(e)){const t=this[e];delete this[e],this._instanceProperties||(this._instanceProperties=new Map),this._instanceProperties.set(e,t)}}_applyInstanceProperties(){for(const[e,t]of this._instanceProperties)this[e]=t;this._instanceProperties=void 0}createRenderRoot(){return this.attachShadow({mode:"open"})}connectedCallback(){this._updateState&Q?void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this):this.requestUpdate()}disconnectedCallback(){}attributeChangedCallback(e,t,n){t!==n&&this._attributeToProperty(e,n)}_propertyToAttribute(e,t,n=Y){const r=this.constructor,o=r._propertyValueToAttribute(t,n);if(void 0!==o){const t=r._attributeNameForProperty(e,n);void 0!==t&&(this._updateState|=ee,null===o?this.removeAttribute(t):this.setAttribute(t,o),this._updateState&=~ee)}}_attributeToProperty(e,t){if(!(this._updateState&ee)){const n=this.constructor,r=n._attributeToPropertyMap.get(e);if(void 0!==r){const e=n._classProperties.get(r);this[r]=n._propertyValueFromAttribute(t,e)}}}requestUpdate(e,t){if(void 0!==e){const n=this.constructor._classProperties.get(e)||Y;return this._requestPropertyUpdate(e,t,n)}return this._invalidate()}_requestPropertyUpdate(e,t,n){return this.constructor._valueHasChanged(this[e],t,n.hasChanged)?(this._changedProperties.has(e)||this._changedProperties.set(e,t),!0===n.reflect&&(void 0===this._reflectingProperties&&(this._reflectingProperties=new Map),this._reflectingProperties.set(e,n)),this._invalidate()):this.updateComplete}async _invalidate(){if(!this._hasRequestedUpdate){this._updateState|=K;let e;const t=this._updatePromise;this._updatePromise=new Promise(t=>e=t),await t,this._validate(),e(!this._hasRequestedUpdate)}return this.updateComplete}get _hasRequestedUpdate(){return this._updateState&K}_validate(){if(this._instanceProperties&&this._applyInstanceProperties(),this.shouldUpdate(this._changedProperties)){const e=this._changedProperties;this.update(e),this._markUpdated(),this._updateState&Q||(this._updateState|=Q,this.firstUpdated(e)),this.updated(e)}else this._markUpdated()}_markUpdated(){this._changedProperties=new Map,this._updateState&=~K}get updateComplete(){return this._updatePromise}shouldUpdate(){return!0}update(){if(void 0!==this._reflectingProperties&&0<this._reflectingProperties.size){for(const[e,t]of this._reflectingProperties)this._propertyToAttribute(e,this[e],t);this._reflectingProperties=void 0}}updated(){}firstUpdated(){}}te._attributeToPropertyMap=new Map,te._finalized=!0,te._classProperties=new Map,te.properties={};const ne=e=>t=>(window.customElements.define(e,t),t),re=e=>(t,n)=>{t.constructor.createProperty(n,e)};class oe extends te{update(e){super.update(e);const t=this.render();t instanceof P&&this.constructor.render(t,this.renderRoot,{scopeName:this.localName,eventContext:this})}render(){}}oe.render=H;var de=function(e,t,n,o){var a,l=arguments.length,s=3>l?t:null===o?o=Object.getOwnPropertyDescriptor(t,n):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,n,o);else for(var p=e.length-1;0<=p;p--)(a=e[p])&&(s=(3>l?a(s):3<l?a(t,n,s):a(t,n))||s);return 3<l&&s&&Object.defineProperty(t,n,s),s},ae=function(e,t){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,t)};class ie extends oe{updated(e){e.has("mathcolor")&&this.style.setProperty("--math-color",this.mathcolor||null),e.has("mathbackground")&&this.style.setProperty("--math-background",this.mathbackground||null)}}de([re({type:String}),ae("design:type",String)],ie.prototype,"mathbackground",void 0),de([re({type:String}),ae("design:type",String)],ie.prototype,"mathcolor",void 0);e.MathElement=class extends ie{render(){return A`
    <style>
      :host {
...
`,me=A`
  ...
  ${se}
  ${pe}
`;e.MathRowElement=class extends ie{render(){return A`
    <style>
      ${ue}
      :host {
        display: inline-block;
    ...
    `}onSlotChange(){if(!this.shadowRoot)return;const e=this.shadowRoot.querySelector("slot"),t=this.shadowRoot.querySelector("#mrowPanel");if(!e||!t)return;t.classList.remove("centered");const n=e.assignedNodes().filter(e=>e.nodeType===Node.ELEMENT_NODE);let r=0,o=0,d=!1;for(let e=0;e<n.length;e++){const t=(n[e].textContent||"").trim();if("="===t){d=!0;break}const a=n[e].tagName.toLowerCase();switch(a){case"m-underover":case"m-under":case"m-over":case"m-subsup":o++;break;case"m-o":r++;break;case"m-table":d=!0;break;default:}}d||!o||r||(d=!0),d&&t.classList.add("centered"),t.classList.remove("justified"),("center"===(getComputedStyle(this).getPropertyValue("--math-underover-align")||"").trim()||"center"===(getComputedStyle(this).getPropertyValue("--math-under-align")||"").trim()||"center"===(getComputedStyle(this).getPropertyValue("--math-over-align")||"").trim())&&t.classList.add("justified")}},e.MathRowElement=function(e,t,n,o){var a,l=arguments.length,s=3>l?t:null===o?o=Object.getOwnPropertyDescriptor(t,n):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,n,o);else for(var p=e.length-1;0<=p;p--)(a=e[p])&&(s=(3>l?a(s):3<l?a(t,n,s):a(t,n))||s);return 3<l&&s&&Object.defineProperty(t,n,s),s}([o("m-row")],e.MathRowElement);e.MathNElement=class extends ie{render(){return A`
    <style>
      :host {
        display: inline-block;
        color: var(--math-color, inherit);
    ...
    <slot></slot>
    `}updated(e){super.updated(e),this.updateAlignment()}},e.MathTDElement=function(e,t,n,o){var a,l=arguments.length,s=3>l?t:null===o?o=Object.getOwnPropertyDescriptor(t,n):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,n,o);else for(var p=e.length-1;0<=p;p--)(a=e[p])&&(s=(3>l?a(s):3<l?a(t,n,s):a(t,n))||s);return 3<l&&s&&Object.defineProperty(t,n,s),s}([o("m-td")],e.MathTDElement);e.MathTRElement=class extends _e{render(){return A`
    <style>
      :host {
        display: table-row;
        color: var(--math-color, inherit);
    ...
    `}updated(e){super.updated(e),this.updateAlignment(),this.refreshSlot()}refreshSlot(){if(this.shadowRoot){const e=this.shadowRoot.querySelector("slot");if(e&&this.columnalign){const t=this.columnalign.trim().split(" ").filter(e=>!!e.trim());if(1<t.length){const n=e.assignedNodes().filter(e=>e.nodeType===Node.ELEMENT_NODE).filter(e=>"M-TD"===e.tagName);for(let e=0;e<t.length&&!(e>=n.length);e++)n[e].columnalign=t[e]}}}}},e.MathTRElement=function(e,t,n,o){var a,l=arguments.length,s=3>l?t:null===o?o=Object.getOwnPropertyDescriptor(t,n):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,n,o);else for(var p=e.length-1;0<=p;p--)(a=e[p])&&(s=(3>l?a(s):3<l?a(t,n,s):a(t,n))||s);return 3<l&&s&&Object.defineProperty(t,n,s),s}([o("m-tr")],e.MathTRElement);e.MathLabeledTRElement=class extends _e{render(){return A`
    <style>
      :host {
        display: table-row;
        color: var(--math-color, inherit);
    ...
    `}refreshSlot(){if(!this.shadowRoot)return;const e=this.shadowRoot.querySelector("slot");if(!e)return;const t=e.assignedNodes().filter(e=>e.nodeType===Node.ELEMENT_NODE);1<t.length&&setTimeout(()=>{const e=t[0].getBoundingClientRect(),n=t[1],r=n.getBoundingClientRect();n.style.opacity="1";const o=[0,0],d=r.bottom-(e.bottom-e.height/2);0<d&&(n.style.top=`${-d}px`,o[0]=d),o[1]=r.width+5,this.style.margin=`${o[0]}px ${o[1]}px 0 0`},50)}},e.MathSupElement=function(e,t,n,o){var a,l=arguments.length,s=3>l?t:null===o?o=Object.getOwnPropertyDescriptor(t,n):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,n,o);else for(var p=e.length-1;0<=p;p--)(a=e[p])&&(s=(3>l?a(s):3<l?a(t,n,s):a(t,n))||s);return 3<l&&s&&Object.defineProperty(t,n,s),s}([o("m-sup")],e.MathSupElement);e.MathSubElement=class extends ie{render(){return A`
    <style>
      ${ue}
      :host {
        display: inline-block;
    ...
    `}refreshSlot(){if(!this.shadowRoot)return;const e=this.shadowRoot.querySelector("slot");if(!e)return;const t=e.assignedNodes().filter(e=>e.nodeType===Node.ELEMENT_NODE);1<t.length&&setTimeout(()=>{const e=t[0].getBoundingClientRect(),n=t[1],r=n.getBoundingClientRect();n.style.opacity="1";const o=[0,0],d=e.height/2;let a=d;d+r.height<e.height?a=e.height-r.height:o[0]=d+r.height-e.height,n.style.top=`${a}px`,o[1]=r.width+5,this.style.margin=`0 ${o[1]}px ${o[0]}px 0`},50)}},e.MathSubElement=function(e,t,n,o){var a,l=arguments.length,s=3>l?t:null===o?o=Object.getOwnPropertyDescriptor(t,n):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,n,o);else for(var p=e.length-1;0<=p;p--)(a=e[p])&&(s=(3>l?a(s):3<l?a(t,n,s):a(t,n))||s);return 3<l&&s&&Object.defineProperty(t,n,s),s}([o("m-sub")],e.MathSubElement);e.MathSubSupElement=class extends ie{constructor(){super(...arguments),this.pendingLayout=!1}render(){return A`
    <style>
      ${ue}
      :host {
        display: inline-block;
    ...
    `}},e.MathPreScriptsElement=function(e,t,n,o){var a,l=arguments.length,s=3>l?t:null===o?o=Object.getOwnPropertyDescriptor(t,n):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,n,o);else for(var p=e.length-1;0<=p;p--)(a=e[p])&&(s=(3>l?a(s):3<l?a(t,n,s):a(t,n))||s);return 3<l&&s&&Object.defineProperty(t,n,s),s}([o("m-prescripts")],e.MathPreScriptsElement);e.MathNoneElement=class extends ie{render(){return A`
    <style>
      :host {
        height: 0;
        width: 0;
    ...
    `}updated(e){super.updated(e);const t=this.style;switch(this.align){case"right":t.setProperty("--math-underover-align","right");break;case"left":t.setProperty("--math-underover-align","left");break;default:t.setProperty("--math-underover-align","center");}t.setProperty("--math-under-font-size",this.accentunder?"1em":"0.75em"),t.setProperty("--math-over-font-size",this.accent?"1em":"0.75em"),this.refreshSlot()}refreshSlot(){if(this.shadowRoot){const e=this.shadowRoot.querySelector("slot");if(e){const t=e.assignedNodes().filter(e=>e.nodeType===Node.ELEMENT_NODE);if(t.length){const e=this.shadowRoot.querySelector("#muoPanel");for(;e.firstChild;)e.removeChild(e.firstChild);2<t.length&&(t[2].classList.add("over"),e.appendChild(t[2])),t[0].classList.add("base"),e.append(t[0]),1<t.length&&(t[1].classList.add("under"),e.appendChild(t[1]))}}}}},Le([re({type:Boolean,reflect:!0}),De("design:type",Object)],e.MathUnderOverElement.prototype,"accent",void 0),Le([re({type:Boolean,reflect:!0}),De("design:type",Object)],e.MathUnderOverElement.prototype,"accentunder",void 0),Le([re(),De("design:type",String)],e.MathUnderOverElement.prototype,"align",void 0),e.MathUnderOverElement=Le([o("m-underover")],e.MathUnderOverElement);e.MathSqrtElement=class extends ie{render(){return A`
    <style>
      ${ue}
      :host {
        display: inline-block;
    ...
    `}updated(e){super.updated(e),this.onSlotCange()}onSlotCange(){if(this.shadowRoot){const e=this.shadowRoot.querySelector("slot");e&&setTimeout(()=>{this.drawRoot()},10)}}drawRoot(){const e=this.shadowRoot.querySelector("#msqrtGlyphSpan"),t=this.shadowRoot.querySelector("#rootPath");if(e&&t){const n=e.getBoundingClientRect(),r=n.width,o=n.height;t.setAttribute("d",`M0 ${.55*o} H${.13*r} L${.45*r} ${o-2} L${r} 0`)}}},e.MathRootElement=function(e,t,n,o){var a,l=arguments.length,s=3>l?t:null===o?o=Object.getOwnPropertyDescriptor(t,n):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,n,o);else for(var p=e.length-1;0<=p;p--)(a=e[p])&&(s=(3>l?a(s):3<l?a(t,n,s):a(t,n))||s);return 3<l&&s&&Object.defineProperty(t,n,s),s}([o("m-root")],e.MathRootElement);var je=function(e,t,n,o){var a,l=arguments.length,s=3>l?t:null===o?o=Object.getOwnPropertyDescriptor(t,n):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,n,o);else for(var p=e.length-1;0<=p;p--)(a=e[p])&&(s=(3>l?a(s):3<l?a(t,n,s):a(t,n))||s);return 3<l&&s&&Object.defineProperty(t,n,s),s},Ae=function(e,t){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,t)};e.MathFracElement=class extends ie{constructor(){super(...arguments),this.bevelled=!1,this.numalign="center",this.denomalign="center"}render(){let e="stroke-width: 1;",t="border-top: solid thin;";return this.linethickness&&"0"===this.linethickness.trim().charAt(0)&&(e="stroke-width: 0;",t=""),A`
    <style>
      :host {
        display: inline-block;
    ...
    <svg></svg>
    `}updated(e){super.updated(e),this.refresh()}refresh(){this.shadowRoot&&this.shadowRoot.querySelector("svg")&&this.shadowRoot.querySelector("slot")&&setTimeout(()=>this.redraw(),100)}adjustPadding(e,t){for(let n=0;n<t.length;n++)e[n]=d(e[n],t[n])}redraw(){const e=this.shadowRoot.querySelector("svg"),n=this.shadowRoot.querySelector("#menclosePanel"),r=this.getBoundingClientRect(),o=[0,0,0,0],d=(this.notation||"").trim().split(" ").filter(e=>!!e.trim());d.forEach(e=>{"longdiv"===e?this.adjustPadding(o,[2,0,0,12]):"actuarial"===e?this.adjustPadding(o,[2,2,0,0]):"radical"===e?this.adjustPadding(o,[2,0,0,18]):"phasorangle"===e?this.adjustPadding(o,[0,0,2,16]):"circle"===e?this.adjustPadding(o,[2,4,2,4]):this.adjustPadding(o,[1,1,1,1])}),n.style.padding=o.join("px ").trim()+"px";const a=r.width+o[1]+o[3],i=r.height+o[0]+o[2];for(e.style.width=`${a}px`,e.style.height=`${i}px`;e.firstChild;)e.removeChild(e.firstChild);n.style.borderTop=null,n.style.borderBottom=null,n.style.borderLeft=null,n.style.borderRight=null,n.style.borderRadius=null,d.forEach(r=>{var t=Math.cos,o=Math.sin,d=Math.PI,l=Math.atan;switch(r){case"longdiv":{const t=document.createElementNS(Ve,"path");t.setAttribute("d",`M0 1 H ${a} M0 1 C 8 ${.33*i} 8 ${.66*i} 0 ${i}`),e.appendChild(t);break}case"actuarial":n.style.borderRight="1px solid",n.style.borderTop="1px solid";break;case"radical":{const t=document.createElementNS(Ve,"path");t.setAttribute("d",`M0 ${.55*i} H${18*.13} L${18*.45} ${i-2} L${18} 1 L${a} 1`),e.appendChild(t);break}case"box":n.style.borderRight="1px solid",n.style.borderTop="1px solid",n.style.borderLeft="1px solid",n.style.borderBottom="1px solid";break;case"roundedbox":n.style.borderRight="1px solid",n.style.borderTop="1px solid",n.style.borderLeft="1px solid",n.style.borderBottom="1px solid",n.style.borderRadius="5px";break;case"circle":{const t=document.createElementNS(Ve,"ellipse");t.setAttribute("cx",`${a/2}`),t.setAttribute("cy",`${i/2}`),t.setAttribute("rx",`${a/2-2}`),t.setAttribute("ry",`${i/2-2}`),e.appendChild(t);break}case"left":n.style.borderLeft="1px solid";break;case"right":n.style.borderRight="1px solid";break;case"top":n.style.borderTop="1px solid";break;case"bottom":n.style.borderBottom="1px solid";break;case"madruwb":n.style.borderRight="1px solid",n.style.borderBottom="1px solid";break;case"updiagonalstrike":{const t=document.createElementNS(Ve,"path");t.setAttribute("d",`M1 ${i-1} L${a-1} ${1}`),e.appendChild(t);break}case"downdiagonalstrike":{const t=document.createElementNS(Ve,"path");t.setAttribute("d",`M1 1 L${a-1} ${i-1}`),e.appendChild(t);break}case"verticalstrike":{const t=document.createElementNS(Ve,"path");t.setAttribute("d",`M${a/2} 1 L${a/2} ${i-1}`),e.appendChild(t);break}case"horizontalstrike":{const t=document.createElementNS(Ve,"path");t.setAttribute("d",`M1 ${i/2} L${a-1} ${i/2}`),e.appendChild(t);break}case"updiagonalarrow":{const n=document.createElementNS(Ve,"path");n.setAttribute("d",`M1 ${i-1} L${a-1} ${1}`),e.appendChild(n);const r=l(i/a),s=d/2-r-d/6,p=d/6+s,h=8*o(s),c=8*t(s),u=document.createElementNS(Ve,"path");u.setAttribute("d",`M${a-1} ${1} L${a-1-h} ${1+c} l${8*-t(p)} ${8*-o(p)} Z`),u.style.fill="currentColor",e.appendChild(u);break}case"phasorangle":{const t=document.createElementNS(Ve,"path");t.setAttribute("d",`M16 1 L1 ${i-1} L${a} ${i-1}`),e.appendChild(t);break}default:}})}},qe([re({type:String}),function(e,t){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,t)}("design:type",Object)],e.MathEncloseElement.prototype,"notation",void 0),e.MathEncloseElement=qe([o("m-enclose")],e.MathEncloseElement);e.MathPhantomElement=class extends ie{render(){return A`
    <style>
      :host {
        display: inline-block;
        visibility: hidden;
    ...
    <slot></slot>
    `}},e.MathPhantomElement=function(e,t,n,o){var a,l=arguments.length,s=3>l?t:null===o?o=Object.getOwnPropertyDescriptor(t,n):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,n,o);else for(var p=e.length-1;0<=p;p--)(a=e[p])&&(s=(3>l?a(s):3<l?a(t,n,s):a(t,n))||s);return 3<l&&s&&Object.defineProperty(t,n,s),s}([o("m-phantom")],e.MathPhantomElement);e.MathErrorElement=class extends ie{render(){return A`
    <style>
      :host {
        display: inline-block;
    ...
    <slot></slot>
    `}},Ie([re({type:String}),function(e,t){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,t)}("design:type",String)],e.MathStyleElement.prototype,"displaystyle",void 0),e.MathStyleElement=Ie([o("m-style")],e.MathStyleElement),e}({});
