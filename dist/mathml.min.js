...
`;let he=class extends oe{render(){return L`
    ...
    <slot></slot>
    `}updated(){this.updateAlignment()}};De=function(e,t,n,o){var a,s=arguments.length,l=3>s?t:null===o?o=Object.getOwnPropertyDescriptor(t,n):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)l=Reflect.decorate(e,t,n,o);else for(var p=e.length-1;0<=p;p--)(a=e[p])&&(l=(3>s?a(l):3<s?a(t,n,l):a(t,n))||l);return 3<s&&l&&Object.defineProperty(t,n,l),l}([r("m-td")],De);let je=class extends Ae{render(){return L`
    <style>
      :host {
        display: table-row;
      }
    ...
    `}updated(){this.refreshSlot()}clearNodes(e){e.forEach(e=>{for(;e.firstChild;)e.removeChild(e.firstChild)})}refreshSlot(){if(this.shadowRoot){const e=this.shadowRoot.querySelector("slot");if(e){const t=e.assignedNodes().filter(e=>e.nodeType===Node.ELEMENT_NODE);if((1!==t.length||t[0].tagName!=="m-prescripts".toUpperCase())&&t.length){const e=this.shadowRoot.querySelector("#lScriptPanel"),r=this.shadowRoot.querySelector("#rScriptPanel"),n=this.shadowRoot.querySelector("#cScriptPanel");this.clearNodes([e,n,r]),n.appendChild(t[0]);let o=0;const d=[],a=[];let s=a;for(let e=1;e<t.length;e++){const r=t[e];r.tagName==="m-prescripts".toUpperCase()?(s=d,o=0):(o%2?r.classList.add("sup"):r.classList.add("sub"),s.push(r),o++)}d.forEach(t=>e.appendChild(t)),a.forEach(e=>r.appendChild(e))}}}}};ze=function(e,t,n,o){var a,s=arguments.length,l=3>s?t:null===o?o=Object.getOwnPropertyDescriptor(t,n):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)l=Reflect.decorate(e,t,n,o);else for(var p=e.length-1;0<=p;p--)(a=e[p])&&(l=(3>s?a(l):3<s?a(t,n,l):a(t,n))||l);return 3<s&&l&&Object.defineProperty(t,n,l),l}([r("m-multiscripts")],ze);let Ue=class extends oe{render(){return L`
    <style>
      :host {
        width: 0;
        height: 0;
